...
# Load parameters
# Load parameteres
with open('../../Data/coupled_model/parameters.pickle', 'rb') as pickle_in:
...
if __name__ == '__main__':
    ...
    # Saving the results
    with open(f'../../data/coupled_model/start_date_analysis/updated/start_date_analysis_10per_m{m}_new.pickle', 'wb') as pickle_out:
